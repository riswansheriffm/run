...
const UnsupervisedInstitutions = ({ unsupervisedInstitutions = {} }) => {
  const { overview, category } = unsupervisedInstitutions;
  ...
  // Update state if unsupervisedInstitutions changes (e.g., async load)
  useEffect(() => {
...
export default UnsupervisedInstitutions;
